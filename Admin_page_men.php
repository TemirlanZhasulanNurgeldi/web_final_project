<?php
    $dbhost = 'localhost';
         $dbuser = 'root';
         $dbpass = '';
         $conn = mysqli_connect($dbhost, $dbuser, $dbpass, 'man');
         ...
         if(isset($_GET['delete'])){
             $sql = "DELETE FROM man WHERE ID=".$_GET['delete'];
	         $result = mysqli_query($conn,$sql);
         }

         if (isset($_GET['Image'])) {
            $sql = "INSERT INTO man (ID, Image, Name, Price, code)
...
<?php
		...
		<div class="price">
          ...
          <div class=""><a href="Admin_page_men.php?delete='.$row['ID'].'">Delete</a></div>
		  </div>
		</div>
        </div>';
    }
    ...
    mysqli_close($conn);
?>
	<form action="Admin_page_men.php" style="margin-right: 50px">
      <table>
            <tr>
                <td>Image(URL): </td>
		...
		<div class="col-md-3 product-bottom">
					...
					<div class="product-go">
						...
						<div class=" fashion-grid1">
							<h6 class="best2"><a href="singleM.html" >Женская стильная блузка</a></h6>
